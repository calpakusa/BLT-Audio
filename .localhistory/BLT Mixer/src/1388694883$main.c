...
#define LED_Phantom		IOPORT_CREATE_PIN(PIOA, 0)

void board_init(void)
{
	ioport_init();
	
	ioport_set_pin_dir(LED_Phantom, IOPORT_DIR_OUTPUT);
/*
	ioport_set_pin_dir(LED_MIC, IOPORT_DIR_OUTPUT);
	ioport_set_pin_dir(LED_LINE, IOPORT_DIR_OUTPUT);
	ioport_set_pin_dir(LED_HBEAT, IOPORT_DIR_OUTPUT);
*/
/*	
